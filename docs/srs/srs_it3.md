...
1. Add a fuzzy search box so our users can search the starts and ends within a certain radius.
2. Create user profiles.
3. Build a landing page.
4. Change frontend's 24-hr time to 12-hr time.
5. Add text wrapping to prevent over-long ride card.
6. Archive rides past date (auto-delete if passes the ride date).
