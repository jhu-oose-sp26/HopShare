...
1. Restrict edit and delete post access to only the poster
2. Implement most robust chat functionality (from simple chats to UI that is more like a messaging app)
3. Update frontend in real time, so users don't have to refresh to see chats
4. Be able to search existing rides by date and time range
5. Have separate tabs to see my rides, profile, messages
6. Deploy app
