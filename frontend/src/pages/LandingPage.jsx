          ...
          <Container>
            ...
            <div className="hs-steps-grid">
              {[
                ...
                { num: '3', label: 'Step three', title: 'Split the cost and go', desc: 'Coordinate with your match, share the ride, and split the fare. Everyone wins.', icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"/></svg> },
              ].map(step => (
